...
/***/ function(module, exports, __webpack_require__) {
	...
	var crudEvents = __webpack_require__(32);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var capi = __webpack_require__(8);
	var cui = __webpack_require__(9);

	var onSignUp = function onSignUp(event) {
	  var data = getFormFields(event.target);
	  event.preventDefault();
	  api.signUp(data).then(function (response_data) {
	  ...
	  }).then(cui.getCheeseplatesSuccess).catch(ui.failure);
	  $('#myModal').modal("hide");
	};
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.signIn(data).then(function (response_data) {
	    ui.signInSuccess(response_data);
	    return capi.getAllCheeses();
	  }).then(function (response_data) {
	    cui.getCheesesSuccess(response_data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Cheese functions
	var getAllCheeses = function getAllCheeses(data) {
	  return $.ajax({
	...
	var getAllCheeseplates = function getAllCheeseplates(data) {
	  return $.ajax({
	...
	var createCheeseplate = function createCheeseplate(data) {
	  return $.ajax({
	    url: app.host + '/cheeseplates',
	...
	var updateCheeseplate = function updateCheeseplate(id, data) {
	  var change = void 0;
	  if (data.cheese.add) {
	    change = '?add=true';
	    delete data.cheese.add;
	  }
	  return $.ajax({
	    // url: 'https://hidden-lowlands-96809.herokuapp.com/cheeses/1',
	    url: app.host + '/cheeseplates/' + id + change,
	    method: 'PATCH',
	    headers: {
	      Authorization: 'Token token=' + app.user.token
	    },
	...
	var deleteCheeseplate = function deleteCheeseplate(id) {
	  return $.ajax({
	    url: app.host + '/cheeseplates/' + id,
	    method: 'DELETE',
	    headers: {
	...
	module.exports = {
	  getAllCheeses: getAllCheeses,
	  // getOneCheeseplate,
	  updateCheeseplate: updateCheeseplate,
	  getAllCheeseplates: getAllCheeseplates,
	  createCheeseplate: createCheeseplate,
	  deleteCheeseplate: deleteCheeseplate
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getCheeses = __webpack_require__(10);
	var getCheeseplates = __webpack_require__(30);
	// const updateCheese = require('../handlebars-templates/update-cheese.handlebars');

	var getCheesesSuccess = function getCheesesSuccess(data) {
	  console.log(data);
	  $('.cheeses-content').html(getCheeses(data));
	};

	var updateCheeseplateSuccess = function updateCheeseplateSuccess(data) {
	  console.log(data);
	...
	var getCheeseplatesSuccess = function getCheeseplatesSuccess(data) {
	  console.log(data);
	  $('.newest-plates').html(getCheeseplates(data));
	  $('.cheesesOnPlateModal').modal('hide');
	  $('body').removeClass('modal-open');
	...
	var deleteCheeseplateSuccess = function deleteCheeseplateSuccess() {
	  console.log('change-name-of-last-cheese');
	  $('.cheeseplate').html(getCheeseplates());
	};

	var createCheeseplateSuccess = function createCheeseplateSuccess(data) {
	...
	var updateCheeseplateFailure = function updateCheeseplateFailure() {
	...
	module.exports = {
	  getCheesesSuccess: getCheesesSuccess,
	  updateCheeseplateSuccess: updateCheeseplateSuccess,
	  failure: failure,
	  createCheeseplateSuccess: createCheeseplateSuccess,
	  getCheeseplatesSuccess: getCheeseplatesSuccess,
	  // getCheeseplateSuccess,
	  deleteCheeseplateSuccess: deleteCheeseplateSuccess,
	  updateCheeseplateFailure: updateCheeseplateFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <div class=\"col-md-3\">\n    <div class=\"col-md-12 inner text-center\">\n      <p class=\"lead text-center\">"
	    ...
	    + "</p>\n      <!--<p class=\"lead text-center\">Cheese ID: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</p>-->\n      <p class=\"text-center\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.description : stack1), depth0))
	    + "</p>\n      <!--<button type=\"button\" class=\"add-cheese-test-button btn btn-default\" data-toggle=\"modal\" data-target=\".addCheeseModal\" data-cheese-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Add</button>-->\n    </div>\n  </div>\n  <!--<div class=\"modal fade text-center addCheeseModal\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cheeseplate : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n            <h4 class=\"modal-title title-new-plate\">Add a cheese</h4>\n        </div>\n        <div class=\"modal-body\">\n            <form class=\"update-cheese-on-plate-form\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cheeseplate : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n              <input type=\"integer\" min=\"1\" max=\"20\" step=\"1\" class=\"new-plate-input form-control\" name=\"cheese[id]\" placeholder=\"Cheese ID\">\n              <input type=\"hidden\" name=\"cheese[add]\" value=\"true\">\n              <button type=\"submit\" class=\"newest-plate btn btn-default\">Submit"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cheeseplate : depth0)) != null ? stack1.id : stack1), depth0))
	    + "</button>\n            </form>\n        </div>\n      </div>\n    </div>\n  </div>-->\n  <!--<button type=\"button\" class=\"update-button\" data-cheese-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update Cheese</button>\n  <input type=\"text\" class=\"new-cheese-name\" data-cheese-name=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" placeholder=\"New cheese name\">-->\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cheeses : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(31),depth0,{"name":"partial","hash":{"cheeseplate":blockParams[0][0]},"data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "<div>\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\">\n      <div class=\"border\">\n        <p class=\"lead\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</p>\n        <div>\n          <button type=\"button\" class=\"add-cheese-button btn btn-default\" data-toggle=\"modal\" data-target=\".cheesesOnPlateModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Add Cheese</button>\n        </div>\n      </div>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cheeses : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "      <!--<div class=\"change-name-of-cheeseplate text-center\">\n        <p class=\"name-change\"> Change the name of this cheeseplate:</p>\n          <form class=\"update-cheeseplate-form text-center\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <input type=\"text\" class=\"cheeseplate-id\" name=\"cheeseplate[id]\" placeholder=\"Cheeseplate ID\"><br>\n            <input type=\"text\" class=\"cheeseplate-name\" name=\"cheeseplate[name]\" placeholder=\"New cheeseplate name\">\n            <button type=\"submit\" class=\"change-cheeseplate-button btn btn-default\">Submit</button>\n          </form>\n      </div>-->\n      <br>\n      <button type=\"button\" class=\"delete-cheeseplate-button btn btn-default\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Delete Cheeseplate</button>\n\n    </li>\n  </ul>\n</div>\n\n\n";
	  ...
	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cheeseplates : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"modal fade text-center cheesesOnPlateModal"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cheeseplate : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cheeseplate : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n  <div class=\"modal-dialog\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-header\">\n        <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title title-new-plate\">Add a cheese</h4>\n      </div>\n      <div class=\"modal-body\">\n          <form class=\"update-cheese-on-plate-form\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.cheeseplate : depth0)) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <input type=\"integer\" class=\"new-plate-input form-control\" name=\"cheese[id]\" placeholder=\"Cheese ID\">\n            <input type=\"hidden\" name=\"cheese[add]\" value=\"true\">\n             <!--<input type=\"submit\">-->\n            <button type=\"submit\" class=\"newest-plate btn btn-default\">Submit</button>\n          </form>\n          <p class=\"duplicate-cheese-message\">Please select a different cheese ID between 1-20.</p>\n      </div>\n    </div>\n  </div>\n</div>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetAllCheeses = function onGetAllCheeses() {
	  console.log('list of all cheeses');
	  api.getAllCheeses().then(ui.getCheesesSuccess).catch(ui.failure);
	};
	...
	var onUpdateCheeseplate = function onUpdateCheeseplate(event) {
	  event.preventDefault();
	  // let id = $(this).data().cheeseplateId;
	  var id = event.target.getAttribute('data-cheeseplate-id');
	  console.log("this is cheeseplate", id);
	  var data = getFormFields(event.target);
	  api.updateCheeseplate(id, data).then(function (response_data) {
	    ui.updateCheeseplateSuccess(response_data);
	    return api.getAllCheeseplates();
	  }).then(ui.updateCheeseplateSuccess).catch(ui.updateCheeseplateFailure);
	};

	var onGetAllCheeseplates = function onGetAllCheeseplates() {
	  event.preventDefault();
	  console.log('list of all cheeseplates');
	  api.getAllCheeseplates().then(ui.getCheeseplatesSuccess).catch(ui.failure);
	};

	var onCreateCheeseplate = function onCreateCheeseplate(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  // debugger;
	  api.createCheeseplate(data).then(function (response_data) {
	    ui.createCheeseplateSuccess(response_data);
	    return api.getAllCheeseplates();
	  }).then(ui.getCheeseplatesSuccess).catch(ui.failure);
	  $('#myModal4').modal("hide");
	};

	var onDeleteCheeseplate = function onDeleteCheeseplate(event) {
	  event.preventDefault();
	  var id = $(this).data().cheeseplateId;
	  console.log(id);
	  api.deleteCheeseplate(id).then(function (response_data) {
