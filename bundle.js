...
/***/ function(module, exports, __webpack_require__) {
	...
	var crudEvents = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateCheese = function onUpdateCheese(event) {
	  event.preventDefault();
	  // let id = $(this).data().cheeseId;
	  // console.log(id);
	  var data = getFormFields(event.target);
	  api.updateCheese(data).then(ui.updateCheeseSuccess).catch(ui.failure);
	};
	...
	var onCreateCheeseplate = function onCreateCheeseplate(event) {
	  ...
	  var data = getFormFields(event.target);
	  // debugger;
	  api.createCheeseplate(data).then(ui.createCheeseplateSuccess).catch(ui.failure);
	  $('#myModal4').modal("hide");
	};
	...
	var onDeleteCheeseplate = function onDeleteCheeseplate(event) {
	  ...
	  console.log(id);
	  api.deleteCheeseplate(id).then(ui.deleteCheeseplateSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getCheeses = __webpack_require__(12);
	var getCheeseplates = __webpack_require__(32);
	...
	var updateCheeseSuccess = function updateCheeseSuccess(data) {
	  console.log(data);
	  $('.cheeses-content').html(getCheeses(data));
	};
	...
	module.exports = {
	  ...
	  updateCheeseSuccess: updateCheeseSuccess,
	  // deleteCheeseSuccess,
	  failure: failure,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "<div class=\"newest-plates\">\n  <ul class=\"list-group\">\n    <li class=\"list-group-item\">\n      <p>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</p>\n      <button type=\"button\" class=\"delete-cheeseplate-button\" data-cheeseplate-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
